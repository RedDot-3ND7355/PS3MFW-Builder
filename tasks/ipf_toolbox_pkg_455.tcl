...
# Priority: 14
# Description: [4.55] Add Rogero's IPF Stealth MM Toolbox instead of [DEFAULT-IPF]!
...
# Option --pkg-label5::
# Option --pkg-label6::
# Option --pkg-enable4: Add The IPF Toolbox PS3_GAME folder To Dev_Flash\pkg (4.55)
...
namespace eval ipf_toolbox_pkg_455 {

    array set ::ipf_toolbox_pkg_455::options {
		...
		--pkg-label5 "                                                                                                            : :"
		--pkg-label6 "                         This task requires the updated LV2 IPF Toolbox-pkg [4.55] patch by Rogero !!		  : :"
		--pkg-enable4 true
		--pkg-enable5 true
		--pkg-enable3 true
		--pkg-label7 "                                                                                                             : :"
    ...
    proc main {} {
        ...
        ::modify_devflash_file $CATEGORY_GAME_TOOL2_XML ::ipf_toolbox_pkg_455::find_nodes
		::modify_devflash_file $CATEGORY_GAME_XML ::ipf_toolbox_pkg_455::inject_nodes
		
		if {$::ipf_toolbox_pkg_455::options(--pkg-enable4)} {
			set pkg [file join ${::CUSTOM_UPDATE_DIR} dev_flash_013.tar.aa.2014_01_29_034614]
			set unpkgdir [file join ${::CUSTOM_UPDATE_DIR} dev_flash_013.tar.aa.2014_01_29_034614.unpkg]
			::unpkg_archive $pkg $unpkgdir
			set tar [file join ${::CUSTOM_UPDATE_DIR} dev_flash_013.tar.aa.2014_01_29_034614.unpkg content]
			...
			set pkg2 [file join ${::CUSTOM_UPDATE_DIR} dev_flash_013.tar.aa.2014_01_29_034614.pkg]
			pkg_archive $unpkgdir $pkg2
			file delete -force $pkg
			file rename -force $pkg2 $pkg
			file delete -force $unpkgdir
			set pkg2 [file join ${::CUSTOM_UPDATE_DIR} dev_flash_013.tar.aa.2014_01_29_034614]
			set unpkgdir3 [file join ${::CUSTOM_UPDATE_DIR} dev_flash dev_flash_013.tar.aa.2014_01_29_034614]
			::unpkg_archive $pkg $unpkgdir3
			set tar2 [file join ${::CUSTOM_UPDATE_DIR} dev_flash dev_flash_013.tar.aa.2014_01_29_034614 content]
		...
		::modify_devflash_file $dst ::ipf_toolbox_pkg_455::copy_devflash_file $src
		}
    }
	...
	proc find_nodes { file } {
		...
		if {$::ipf_toolbox_pkg_455::options(--pkg-enable5)} {
        ...
        if {$::ipf_toolbox_pkg_455::options(--pkg-enable3)} {
