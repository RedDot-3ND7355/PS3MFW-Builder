...
# Priority: 13
# Description: [4.50] Add Rogero's IPF Stealth MM Toolbox instead of [DEFAULT-IPF]!
...
# Option --pkg-label5::
# Option --pkg-label6::
# Option --pkg-enable4: Add The IPF Toolbox PS3_GAME folder To Dev_Flash\pkg (4.50)
...
namespace eval ipf_toolbox450_pkg {

    array set ::ipf_toolbox450_pkg::options {
	
		--pkg-label "---------------------------------- Welcome To The IPF Toolbox PS3_GAME Section --------------------------------   : :"
		--pkg-label1 "                                                                                                            : :"
		...
		--pkg-label5 "                                                                                                            : :"
		--pkg-label6 "                         This task requires the updated LV2 IPF Patch [4.5x] patch by Rogero !!		  : :"
		--pkg-enable4 false
		--pkg-enable5 false
		--pkg-enable3 false
		--pkg-label7 "                                                                                                             : :"
    ...
    proc main {} {
        ...
        ::modify_devflash_file $CATEGORY_GAME_TOOL2_XML ::ipf_toolbox450_pkg::find_nodes
		::modify_devflash_file $CATEGORY_GAME_XML ::ipf_toolbox450_pkg::inject_nodes
		
		if {$::ipf_toolbox450_pkg::options(--pkg-enable4)} {
		...
		::modify_devflash_file $dst ::ipf_toolbox450_pkg::copy_devflash_file $src
		}
    }
	...
	proc find_nodes { file } {
		...
		if {$::ipf_toolbox450_pkg::options(--pkg-enable5)} {
        ...
        if {$::ipf_toolbox450_pkg::options(--pkg-enable3)} {
