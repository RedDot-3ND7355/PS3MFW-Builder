...
#		exit}
    ...
    proc add_about_msg { about } {
		...
		pack [::ttk::label $about.24 -text "Contributors :" -anchor center] -expand false -fill x
		pack [::ttk::label $about.25 -text "RazorX" -anchor center] -expand false -fill x
		pack [::ttk::label $about.26 -text "haz367" -anchor center] -expand false -fill x
        pack [::ttk::label $about.27 -text "Habib" -anchor center] -expand false -fill x
		pack [::ttk::label $about.28 -text "Naewhert" -anchor center] -expand false -fill x
		pack [::ttk::label $about.29 -text "toolboy2012" -anchor center] -expand false -fill x
		pack [::ttk::label $about.30 -text "Arachetous" -anchor center] -expand false -fill x
		pack [::ttk::label $about.31 -text "Ps3Hax Network members" -anchor center] -expand false -fill x
		pack [::ttk::label $about.32 -text "For all kind of epic stuffing!" -anchor center] -expand false -fill x
    }
